      ...
      <section>
        <div className='px-8 py-12'>
          <div className='flex flex-col md:flex-row'>
            ...
            <img src="/images/IMG-20241208-WA0074.jpg" alt="Image description" width="500" />{/* <img src={'/images/public/images/IMG-20241208-WA0074.jpg'} width={400} height={400} alt='right' /> */}
            </div>
          </div>
        </div>
      </section>
